...
namespace OnlineStoreApp.Migrations
{
    ...
    [Migration("20231030123516_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineStoreApp.Models.Image", b =>
                {
            ...
            modelBuilder.Entity("OnlineStoreApp.Models.Item", b =>
                {
                    ...
                    b.ToTable("tbl_Items", (string)null);
            ...
            modelBuilder.Entity("OnlineStoreApp.Models.ShoppingCart", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)")
                    ...
                    b.ToTable("tbl_ShoppingCart", (string)null);
                });

            modelBuilder.Entity("OnlineStoreApp.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "quantitnamey");
                    ...
                    b.ToTable("tbl_ShoppingCartItem", (string)null);
            ...
            modelBuilder.Entity("OnlineStoreApp.Models.ShoppingCartItem", b =>
                {
                    b.HasOne("OnlineStoreApp.Models.ShoppingCart", null)
                        .WithMany("CartItems")
